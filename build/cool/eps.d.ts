declare namespace Eps {
	...
	interface FreeActivityClaimLogEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface FreeActivityUsageLogEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface DistributionConfig {
		 ...
		 * 权限标识
		 */
		permission: { update: string; info: string };

		/**
		 * 权限状态
		 */
		_permission: { update: boolean; info: boolean };

		request: Service["request"];
	}

	interface DistributionDistributor {
		/**
		 * 调整邀请关系
		 */
		changeBinding(data?: any): Promise<any>;

		/**
		 * 更新个人佣金比例(bp)
		 */
		updateRate(data?: any): Promise<any>;

		/**
		 * 冻结/解冻分销商
		 */
		freeze(data?: any): Promise<any>;
	...
	interface DistributionStatistics {
		 ...
		 * 导出佣金数据
		 */
		commission(data?: any): Promise<any>;
	...
	interface DistributionWithdrawal {
		 ...
		 * 同步 Paystack 打款状态
		 */
		syncPaystack(data?: any): Promise<any>;

		/**
		 * 手动标记打款失败
		 */
		markFailed(data?: any): Promise<any>;

		/**
		 * 手动标记打款成功
		 */
		markPaid(data?: any): Promise<any>;
	...
	interface FreeActivityClaimLog {
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
			pagination: { size: number; page: number; total: number; [key: string]: any };
			list: FreeActivityClaimLogEntity[];
			[key: string]: any;
		}>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<FreeActivityClaimLogEntity>;
	...
	interface FreeActivityUsageLog {
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
			pagination: { size: number; page: number; total: number; [key: string]: any };
			list: FreeActivityUsageLogEntity[];
			[key: string]: any;
		}>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<FreeActivityUsageLogEntity>;
	...
	type Service = {
		...
		freeActivity: {
			claimLog: FreeActivityClaimLog;
			config: FreeActivityConfig;
			usageLog: FreeActivityUsageLog;
		};
		goods: {
